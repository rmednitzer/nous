...
- BL-005a [in-progress] (L1) APU subsystem (solar PV + MPPT, methanol fuel cell, vehicle tether, USB-C PD-in, hand-crank). Subsystem, per-source Kalman, and `apu_status` tool wired; see ADR-0015.
